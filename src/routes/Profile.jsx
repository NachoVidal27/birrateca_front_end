        ...
        <div className="h-80 w-[70%] mx-auto">
          ...
          <form action="">
            <div className="grid grid-cols-2 my-3 mx-4">
              ...
              <input type="text" className="border border-black rounded px-2" value={user.name} />
            </div>
            <hr />
            <div className="grid grid-cols-2 my-3 mx-4">
              ...
              <input type="text" className="border border-black rounded px-2" value={user.memberId} />
            </div>
            <hr />
            <div className="grid grid-cols-2 my-3 mx-4">
              ...
              <input type="text" className="border border-black rounded px-2" value={user.phone} />
            </div>
            <hr />
            <div className="grid grid-cols-2 my-3 mx-4">
              ...
              <input type="text" className="border border-black rounded px-2 " value={user.email} />
            </div>
            <hr />
